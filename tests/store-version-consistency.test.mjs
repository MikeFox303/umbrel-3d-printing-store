...
const packages = [
  {
    ...
    normalizeManifest: (version) => version,
  },
  {
    id: 'my3d-printbuddy',
    image: /image:\s+docker\.io\/vmhomelabde\/printbuddy:v([^@\s]+)/,
    normalizeManifest: (version) => version.replace(/-umbrel\.\d+$/, ''),
  },
  {
    id: 'my3d-spoolman',
